...
import com.giuliana.evaluacioncontinuacuatro.databinding.ActivityLoginBinding
...
class LoginActivity : AppCompatActivity() {
    ...
    private fun isCredentialsValidated(): Boolean {
        return validateInputs(binding.email.editText?.text.toString(),binding.password.editText?.text.toString())
    }
