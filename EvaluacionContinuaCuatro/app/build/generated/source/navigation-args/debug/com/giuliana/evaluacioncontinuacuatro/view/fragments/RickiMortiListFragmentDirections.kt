...
public class RickiMortiListFragmentDirections private constructor() {
  private data class ActionRickiMortiListFragmentToRickiMortiDetailFragment(
    public val results: Rickimorti
  ) : NavDirections {
    public override val actionId: Int =
        R.id.action_rickiMortiListFragment_to_rickiMortiDetailFragment
  ...
  public companion object {
    public fun actionRickiMortiListFragmentToRickiMortiDetailFragment(results: Rickimorti):
        NavDirections = ActionRickiMortiListFragmentToRickiMortiDetailFragment(results)
  }
}
